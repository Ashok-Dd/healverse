...
const Conversations = () => {
    ...
    const renderItem = useCallback(({ item }) => (
        <Pressable
            className="mx-3 my-2 bg-white rounded-2xl border border-gray-100 px-4 py-3 shadow-md active:bg-gray-50"
        ...
        <SafeAreaView className="flex-1 bg-white">
            <View className="px-6 pt-2 pb-4">
                <View className="flex-row items-center mb-4">
                    ...
                    <Text className="text-md font-bold text-gray-900">Conversations</Text>
                </View>
                    ...
                    ListEmptyComponent={
                        <View className="flex-1 justify-center items-center px-8">
                            ...
                            <Text className="text-xl font-semibold text-gray-900 mb-2 text-center mt-4">
                                {search.length > 0 ? "No results found" : "No conversations yet"}
                            </Text>
                            ...
                            {search.length > 0 ? (
                                <Pressable
                                    ...
                                    accessibilityLabel="Clear Search"
                                >
                                    <Text className="text-gray-700 font-semibold">Clear Search</Text>
                                </Pressable>
                            ) : (
                                <Pressable
            ...
            >
                <BottomSheetView className="flex-1 px-6 py-4">
                    ...
                    >
                        ...
                        <Text className="ml-3 text-blue-500 font-medium text-base">Rename</Text>
                    </Pressable>
                    ...
                    >
                        ...
                        <Text className="ml-3 text-red-500 font-medium text-base">Delete</Text>
                    </Pressable>
                    ...
                    >
                        ...
                        <Text className="ml-3 text-gray-600 font-medium text-base">Cancel</Text>
                    </Pressable>
                </BottomSheetView>
            </BottomSheet>
        </SafeAreaView>
