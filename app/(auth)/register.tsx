  ...
  return (
    <SafeAreaView className="flex-1 p-5">
      ...
      <View className="px-4 py-6  rounded-xl space-y-2">
        ...
        />
        <InfoRow
          icon={<MaterialIcons name="height" size={20} color="black" />}
          label="Height"
          value={`${profile.heightCm} cm`}
        />
        <InfoRow
          icon={<FontAwesome5 name="birthday-cake" size={20} color="black" />}
          label="Age"
          value={`${profile.age}`}
        />
        <InfoRow
        ...
        />
        <InfoRow
          icon={<FontAwesome5 name="bullseye" size={20} color="black" />}
          label="Target Weight"
          value={`${profile.targetWeightKg} kg`}
        />
        <InfoRow
          icon={<FontAwesome5 name="couch" size={20} color="black" />}
          label="Activity Level"
          value={profile.activityLevel.replace("_", " ").toLowerCase()}
        />
        <InfoRow
          icon={<FontAwesome5 name="flag-checkered" size={20} color="black" />}
          label="Goal"
          value={profile.goal.replace("_", " ").toLowerCase()}
        />
        <InfoRow
          icon={<FontAwesome5 name="hourglass-start" size={20} color="black" />}
        ...
        />
        <InfoRow
          icon={<FontAwesome5 name="heartbeat" size={20} color="black" />}
        ...
        {profile.healthCondition === "OTHER" &&
          profile.otherHealthConditionDescription && (
            <InfoRow
              icon={<FontAwesome5 name="sticky-note" size={20} color="black" />}
      ...
      {error && (
        <Text className=" text-center rounded-full p-1 my-3 text-white bg-red-200">
          {error}
        </Text>
      )}
