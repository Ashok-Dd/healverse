...
export type UpdateFoodLogData = Partial<
  Omit<FoodLog, "id" | "user" | "createdAt">
>;

export type CreateExerciseLogData = Omit<ExerciseLog, "id" | "createdAt">;
export type UpdateExerciseLogData = Partial<
  Omit<ExerciseLog, "id" | "user" | "createdAt">
>;

export type CreateWaterLogData = Omit<WaterLog, "id" | "createdAt">;
export type UpdateWaterLogData = Partial<
