...
interface ChatScreenProps {
    ...
    isExistingConversation?: boolean; // New prop to indicate if this is an existing conversation
}

const ChatScreen = ({ conversationId, isExistingConversation = false }: ChatScreenProps) => {
